...
const FlowSidebar = ({
  ...
  // State variable to toggle sidebar
    ...
    <>
      ...
      <div className="w-full navbar text-white bg-[#384451] lg:hidden">
        <div className="flex-none lg:hidden">
          <Button
            className="bg-[#54606e] focus:ring-0"
            color="#54606e"
        ...
        <div className="flex-1 px-2 mx-2">Pecha Line Tool</div>
      </div>
      <Sidebar
        aria-label="Default sidebar example"
        className={`hidden w-80 lg:block ${
          isSidebarOpen
            ? "fixed top-16 bg-black bg-opacity-50 z-50 flex"
            : "hidden"
        }`}
        theme={{
          root: {
